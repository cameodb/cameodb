...
## Phase 11: Read/Write Workflow Hot-Path Optimizations

**Implementation Steps:**
1. **Remove Tantivy ID roundtrip in search hits**
...
2. **Tighten duplicate work inside `apply_batch()`**
...
3. **Enforce configured shard and remote concurrency limits**
...
4. **Reduce worker-pool coordination contention**
...
5. **Improve early-termination and result-merge behavior**
...
7. **Implement incremental write-stream ingestion**
...
- 🚧 **Phase 11 (Workflow Hot-Path Optimizations)**: Planned – ordered from lower-risk search/write improvements to more complex end-to-end streaming work.

### **Recommended Next Steps**
1. **Search Hit Optimization**: Remove the Tantivy `id` extraction roundtrip first
2. **Batch Path Tightening**: Remove duplicate work in `apply_batch()` before broader architectural changes
3. **Streaming Modernization**: Reserve end-to-end search and write streaming for the final Phase 11 steps
